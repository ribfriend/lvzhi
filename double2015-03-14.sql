...
CREATE TABLE `agent` (
  ...
  `user_num` varchar(18) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '身份证号',
  PRIMARY KEY (`id`),
...
-- Records of agent
-- ----------------------------
INSERT INTO `agent` VALUES ('1', '1', '20150313000000', '0', '淘宝', '1', '测试', '13800138000', '广东深圳', '2015-12-31 09:55:38', '0', '123123', '一级代理商', null);
INSERT INTO `agent` VALUES ('3', '2', '2015031320000', '1', '淘宝', '1', '测试内容', '13800138000', '广东甚则很难', '2015-12-31 17:20:57', '0', '2342342', '二级代理商', null);
INSERT INTO `agent` VALUES ('4', '3', '20150313000000', '3', '淘宝', '1', '测试', '13800138000', '广东深圳', '2015-12-31 09:55:38', '0', '123123', '一级代理商', null);
